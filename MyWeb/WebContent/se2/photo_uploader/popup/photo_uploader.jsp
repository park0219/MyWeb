...
<script language="javascript">
    ...
    function fn_imageUp5() {
    	if(!document.editor_upimage5.Filedata.value){
    		alert("파일을 첨부해주세요.");
    		return false;
    	}
...
<div id="pop_wrap">
    ...
    <div id="pop_container2" class="pop_container2">
        ...
        <div id="pop_footer">
            <div class="btn_area">
                <a href="#a" onClick="fn_imageUp();"><img src="/commons/cmm/editor/img/photoQuickPopup/btn_confirm.png" width="49" height="28" alt="확인"></a>
                <a href="#a" onClick="fn_close();"><img src="/commons/cmm/editor/img/photoQuickPopup/btn_cancel.png" width="48" height="28" alt="취소"></a>
            </div>
        </div>
        <!-- //content -->
    ...
    <div id="pop_container" class="pop_container" style="display:none;">
        ...
        <div id="pop_footer">
        <div class="btn_area">
            <a href="#a" onClick="fn_imageUp5();"><img src="../../img/photoQuickPopup/btn_confirm.png" width="49" height="28" alt="확인"></a>
            <a href="#a" onClick="fn_close();"><img src="../../img/photoQuickPopup/btn_cancel.png" width="48" height="28" alt="취소"></a>
        </div>
    </div>
        <!-- //content -->
    </div>
