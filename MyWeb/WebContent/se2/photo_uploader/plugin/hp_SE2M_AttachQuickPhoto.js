...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({        
    ...
    makePopupURL : function(id){
    	//alert(nhn.husky.PopUpManager.setCallback);
    	//alert(nhn.husky.EZCreator.createInIFrame.htOptions.oAppRef);
    	//alert(this.oApp);
    	//alert(id);
        var sPopupUrl = "./photo_uploader/popup/photo_uploader.jsp?id="+id;
